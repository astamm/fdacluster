...
// kmap
Rcpp::List kmap(const arma::mat& x, const arma::cube& y, const arma::urowvec& seeds, const arma::rowvec& warping_options, const unsigned int& n_clust, const unsigned int& maximum_number_of_iterations, const unsigned int& number_of_threads, const unsigned int& parallel_method, const double& distance_relative_tolerance, const bool& cluster_on_phase, const bool& use_fence, const bool& check_total_dissimilarity, const bool& use_verbose, const bool& compute_overall_center, const std::string& warping_method, const std::string& center_method, const std::string& dissimilarity_method, const std::string& optimizer_method);
RcppExport SEXP _fdacluster_kmap(SEXP xSEXP, SEXP ySEXP, SEXP seedsSEXP, SEXP warping_optionsSEXP, SEXP n_clustSEXP, SEXP maximum_number_of_iterationsSEXP, SEXP number_of_threadsSEXP, SEXP parallel_methodSEXP, SEXP distance_relative_toleranceSEXP, SEXP cluster_on_phaseSEXP, SEXP use_fenceSEXP, SEXP check_total_dissimilaritySEXP, SEXP use_verboseSEXP, SEXP compute_overall_centerSEXP, SEXP warping_methodSEXP, SEXP center_methodSEXP, SEXP dissimilarity_methodSEXP, SEXP optimizer_methodSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(kmap(x, y, seeds, warping_options, n_clust, maximum_number_of_iterations, number_of_threads, parallel_method, distance_relative_tolerance, cluster_on_phase, use_fence, check_total_dissimilarity, use_verbose, compute_overall_center, warping_method, center_method, dissimilarity_method, optimizer_method));
