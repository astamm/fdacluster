...
has been considered, one choose use affine warping and search for $2$ groups
when the goal is to cluster based on the amplitude data.
...
to use affine warping but to search for $3$ groups.
