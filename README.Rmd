...
The [**fdacluster**](https://astamm.github.io/fdacluster/) package provides the [`kma()`](https://astamm.github.io/fdacluster/reference/kma.html) function that jointly performs clustering and alignment of a functional data set.
...
You can install the latest stable version of [**fdacluster**](https://astamm.github.io/fdacluster/) from CRAN with:
``` r
install.packages("fdacluster")
```

Or you can install the development version from [GitHub](https://github.com/astamm/fdacluster) with:
